...
<div class="flex px-24 py-5 bg-white fixed inset-x-0 top-0 z-30">
    ...
    <form action="{{ url('/test')}}" method="post">
        ...
        <input type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold py-4 px-6 rounded-full" value="Rent a bike">
        </div>
    </form>

    <script type="text/javascript">
        mapboxgl.accessToken = 'pk.eyJ1IjoiamFyaS1tZXNpbmEiLCJhIjoiY2syZzF6bjdxMGczdzNjbzFqN200OXV5MiJ9.bwOLa4uAkF4mNzmobFHrnQ';
